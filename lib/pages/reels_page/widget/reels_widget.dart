...
//     customChanges["like"] =
//         int.parse(controller.mainReels[widget.index].totalLikes.toString());
//     customChanges["comment"] =
//         int.parse(controller.mainReels[widget.index].totalComments.toString());
//   }
...
//                           child:
//                               LinearProgressIndicator(color: AppColor.primary))
//                       : SizedBox.expand(
//                           child: FittedBox(
//                             fit: BoxFit.cover,
//                             child: SizedBox(
...
//                       onTap: () {
//                         Utils.showLog(
//                             "Video User Id => ${controller.mainReels[widget.index].userId} => ${Database.loginUserId}");
//                         if (controller.mainReels[widget.index].userId !=
...
//                       onTap: () {
//                         Utils.showLog(
//                             "Song Id => ${controller.mainReels[widget.index].songId}");
//                         if (controller.mainReels[widget.index].songId != "" &&
//                             controller.mainReels[widget.index].songId != null) {
//                           isReelsPage.value = false;
//                           Get.toNamed(AppRoutes.audioWiseVideosPage,
//                               arguments:
//                                   controller.mainReels[widget.index].songId);
//                         } else if (controller.mainReels[widget.index].userId !=
//                             Database.loginUserId) {
//                           isReelsPage.value = false;
//                           PreviewProfileBottomSheetUi.show(
//                             context: context,
//                             userId:
//                                 controller.mainReels[widget.index].userId ?? "",
//                           );
//                         } else {
//                           isReelsPage.value = false;
...
//                                         image: controller
//                                             .mainReels[widget.index].userImage),
//                                     Visibility(
//                                       visible: controller
//                                               .mainReels[widget.index]
...
//                         10.height,
//                         Visibility(
//                           visible: controller.mainReels[widget.index].caption
//                                   ?.trim()
//                                   .isNotEmpty ??
//                               false,
//                           child: ReadMoreText(
